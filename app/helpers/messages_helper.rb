...
module MessagesHelper
  ...
  def message_class(message)
    ...
    classes << 'bg-blue-400 text-white col-start-2 col-span-3 my-message' if message.user.id == current_user.id
    classes << 'bg-gray-200 col-span-3 partner-message' if message.user.id != current_user.id
